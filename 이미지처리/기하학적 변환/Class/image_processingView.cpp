...
BEGIN_MESSAGE_MAP(CimageprocessingView, CView)
	...
	ON_COMMAND(ID_SHARPNING, &CimageprocessingView::OnSharpning)
	ON_COMMAND(ID_HDF_SHARP, &CimageprocessingView::OnHdfSharp)
...
void CimageprocessingView::OnSharpning()
{
	CimageprocessingDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
...
void CimageprocessingView::OnHdfSharp()
{
	CimageprocessingDoc* pDoc = GetDocument();
	ASSERT_VALID(pDoc);
